...
if(version!=='3.20.7'||product.commit!=='979197d5570b168c034c634b3e21f2bea3ea5be0')throw new Error('This patch supports Cursor 3.20.7 build 979197d only.');
...
for(const surface of ['desktop','glass']){
  ...
  source=patchPickerSections(source,once,desktop
    ?{groupReturn:'return c.mergeLeadingIntoPromotedSection===!0?{leading:[],promoted:[...re,...J],others:ce}:{leading:re,promoted:J,others:ce}',
      promotedAnchor:'WP(fmt,{models:B.promoted,title:c?.promotedSectionTitle',modelsVar:'B',jsx:'WP',fmt:'fmt',renderModel:'x'}
    :{groupReturn:'return l.mergeLeadingIntoPromotedSection===!0?{leading:[],promoted:[...te,...Q],others:ie}:{leading:te,promoted:Q,others:ie}',
      promotedAnchor:'vF(p8t,{models:N.promoted,title:l?.promotedSectionTitle',modelsVar:'N',jsx:'vF',fmt:'p8t',renderModel:'k'});
  ...
  const models=desktop?'c':'l', mapper=desktop?'V=>lpn(V)':'U=>kzn(U)';
  ...
  if(source.includes('const __chatgptLocal=__isChatgptBridgeModel(u?.requestedModel?.modelId??i?.modelId);')){
    ...
    const before=desktop?'async run(e,t,n,i,r,s,o,a,c,l,u){const h=Bjf(u,':'async run(t,e,n,i,r,s,o,a,l,c,u){const d=fyS(u,';
  ...
  const activation=desktop?'function edp(e){return Qc.localMode&&e?.get(Qey,-1)==="true"}':'function mIg(t){return Cl.localMode&&t?.get(wIg,-1)==="true"}';
  ...
  const usage=desktop
    ?{jsx:'M0t',useState:'Klr',useEffect:'avp',card:'Jb',zs:'zs',bar:'EA',barStyle:'tur',
      fn:'function O_y(e){const t=Hfp(119)',
      children:'title:"Plan & Usage",children:[yn,an,Kt,xn]',
      childrenGpt:'title:"Plan & Usage",children:[yn,an,Kt,xn,M0t(__chatgptUsageSection,{})]'}
    :{jsx:'cH1',useState:'vgr',useEffect:'dfd',card:'Yf',zs:'Ks',bar:'Im',barStyle:'mTi',
      fn:'function hH1(t){const e=sDg(119)',
      children:'title:"Plan & Usage",children:[ft,wt,gt,Tt]',
      childrenGpt:'title:"Plan & Usage",children:[ft,wt,gt,Tt,cH1(__chatgptUsageSection,{})]'};
